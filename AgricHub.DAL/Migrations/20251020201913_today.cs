        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NoShowCount = table.Column<int>(type: "int", nullable: true),
                    PaystackRecipientCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Wallet_CustomerOrConsultant", "(CustomerId IS NOT NULL AND ConsultantId IS NULL) OR (CustomerId IS NULL AND ConsultantId IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaystackTransactionReference = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_Consultants_ConsultantId",
                        column: x => x.ConsultantId,
                        principalTable: "Consultants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomOffers_ChatSessions_ChatSessionId",
                        column: x => x.ChatSessionId,
                        principalTable: "ChatSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomOffers_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SendbirdChannelUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliverablesPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConsultantNoShowReported = table.Column<bool>(type: "bit", nullable: false),
                    CustomerNoShowReported = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsCustomOffer = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Consultations_ServicePackages_ServicePackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PendingTransactions_Consultations_ConsultationId",
                        column: x => x.ConsultationId,
                        principalTable: "Consultations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PendingTransactions_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomOffers_ChatSessionId",
                table: "CustomOffers",
                column: "ChatSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomOffers_ServiceId",
                table: "CustomOffers",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_PendingTransactions_ConsultationId",
                table: "PendingTransactions",
                column: "ConsultationId");

            migrationBuilder.CreateIndex(
                name: "IX_PendingTransactions_CustomerId",
                table: "PendingTransactions",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_ConsultantId",
